...
@app.route('/')
def index():
    return render_template('index4.html', submitted_phrase=None, audio_url=None)
...
def submit():
    ...
    return render_template('index4.html', submitted_phrase=input_string, audio_url=audio_url)
